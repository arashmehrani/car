        ...
        <!-- Timeline Content -->
            <div class="card timeline-card bg-info">
                <div class="card-body">
                    ...
                    @if(!empty($service->meta['bime_sales']))
                        <div class="timeline-tags"><span
                                class="badge bg-light text-dark">+ بیمه شخص ثالت</span>
                        </div>
                    @endif
                    @if(!empty($service->meta['bime_badane']))
                        <div class="timeline-tags"><span
                                class="badge bg-light text-dark">+ بیمه بدنه</span>
                        </div>
                    @endif
