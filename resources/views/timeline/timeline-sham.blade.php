...
@section('content')
    <div class="container">
        ...
        <div class="element-heading">
            <h6>لیست سرویس های شمع و وایر</h6>
        </div>
    </div>
    <div class="container">
        ...
        <!-- Timeline Content -->
            <div class="card timeline-card bg-info">
                <div class="card-body">
                    ...
                    @if(!empty($service->meta['sham']))
                        <div class="timeline-tags"><span
                                class="badge bg-light text-dark">+ شمع ها تعویض شده</span>
                        </div>
                    @endif
                    @if(!empty($service->meta['wire']))
                        <div class="timeline-tags"><span
                                class="badge bg-light text-dark">+ وایر ها تعویض شده</span>
                        </div>
                    @endif
