                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="timeline-text mb-2"><span
                            ...
                            <h6>برند مصرفی: {{$service->title}}</h6>
                        </div>
                    ...
                    @if(!empty($service->meta['tas_time']))
                        <div class="timeline-tags"><span
                                class="badge bg-light text-dark">+ تسمه تایم تعویض شده</span>
                        </div>
                    @endif
                    @if(!empty($service->meta['tas_hydro']))
                        <div class="timeline-tags"><span
                                class="badge bg-light text-dark">+ تسمه هیدرولیک تعویض شده</span>
                        </div>
                    @endif
                    @if(!empty($service->meta['tas_dinam']))
                        <div class="timeline-tags"><span
                                class="badge bg-light text-dark">+ تسمه دینام تعویض شده</span>
                        </div>
                    @endif
                    @if(!empty($service->meta['tas_ac']))
                        <div class="timeline-tags"><span
                                class="badge bg-light text-dark">+ تسمه کولر تعویض شده</span>
                        </div>
                    @endif
