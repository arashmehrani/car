...
@section('content')
    <div class="container">
        ...
        <div class="element-heading">
            <h6>لیست سرویس های روغن موتور</h6>
        </div>
    </div>
    <div class="container">
        ...
        <!-- Timeline Content -->
            <div class="card timeline-card bg-info">
                <div class="card-body">
                    ...
                    @if(!empty($service->meta['romo_filter']))
                        <div class="timeline-tags"><span
                                class="badge bg-light text-dark">+ فیلتر روغن تعویض شده</span>
                        </div>
                    @endif
                    @if(!empty($service->meta['air_filter']))
                        <div class="timeline-tags"><span
                                class="badge bg-light text-dark">+ فیلتر هوا تعویض شده</span>
                        </div>
                    @endif
                    @if(!empty($service->meta['cabin_filter']))
                        <div class="timeline-tags"><span
                                class="badge bg-light text-dark">+ فیلتر کابین تعویض شده</span>
                        </div>
                    @endif
                    @if(!empty($service->meta['ro_hydro']))
                        <div class="timeline-tags"><span
                                class="badge bg-light text-dark">+ روغن هیدرولیک تعویض شده</span>
                        </div>
                    @endif
