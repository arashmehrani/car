        ...
        <!-- Timeline Content -->
            <div class="card timeline-card bg-info">
                <div class="card-body">
                    ...
                    @if(!empty($service->meta['lent_front']))
                        <div class="timeline-tags"><span
                                class="badge bg-light text-dark">+ لنت های جلو تعویض شده</span>
                        </div>
                    @endif
                    @if(!empty($service->meta['lent_back']))
                        <div class="timeline-tags"><span
                                class="badge bg-light text-dark">+ لنت های عقب تعویض شده</span>
                        </div>
                    @endif
