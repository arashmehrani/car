        ...
        <!-- Timeline Content -->
            <div class="card timeline-card bg-info">
                <div class="card-body">
                    ...
                    @if(!empty($service->meta['lastik_front']))
                        <div class="timeline-tags"><span
                                class="badge bg-light text-dark">+ لاستیک های جلو تعویض شده</span>
                        </div>
                    @endif
                    @if(!empty($service->meta['lastik_back']))
                        <div class="timeline-tags"><span
                                class="badge bg-light text-dark">+ لاستیک های عقب تعویض شده</span>
                        </div>
                    @endif
