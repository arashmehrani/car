...
@section('content')
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{route('service.lent.post')}}">
                    @csrf
                    <input type="hidden" name="plate_id" value="{{$id}}">
                    <div class="form-group">
                        <label class="form-label" for="title">برند محصول</label>
                        <input class="form-control" id="title" name="title" type="text" placeholder="مثال: پارس"
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input form-check-success" name="lent_front" id="lent_front" type="checkbox"
                               value="on" checked>
                        <label class="form-check-label text-justify" for="lent_front">لنت های جلو تعویض شده</label>
                    </div>
                    <div class="form-check mb-3">
                        <input class="form-check-input form-check-success" name="lent_back" id="lent_back" type="checkbox"
                               value="on">
                        <label class="form-check-label text-justify" for="lent_back">لنت های عقب تعویض شده</label>
                    </div>
