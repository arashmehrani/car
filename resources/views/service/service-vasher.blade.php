...
@section('content')
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{route('service.vasher.post')}}">
                    @csrf
                    <input type="hidden" name="plate_id" value="{{$id}}">
                    <div class="form-group">
                        <label class="form-label" for="title">برند محصول</label>
                        <input class="form-control" id="title" name="title" type="text" placeholder="مثال: واشر الدورا"
