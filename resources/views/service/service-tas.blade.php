...
@section('content')
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{route('service.tas.post')}}">
                    @csrf
                    <input type="hidden" name="plate_id" value="{{$id}}">
                    <div class="form-group">
                        <label class="form-label" for="title">برند محصول</label>
                        <input class="form-control" id="title" name="title" type="text" placeholder="مثال: ایساکو"
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input form-check-success" name="tas_time" id="tas_time" type="checkbox"
                               value="on" checked>
                        <label class="form-check-label text-justify" for="tas_time">تسمه تایم تعویض شده</label>
                    </div>
                    <div class="form-check mb-3">
                        <input class="form-check-input form-check-success" name="tas_hydro" id="tas_hydro" type="checkbox"
                               value="on">
                        <label class="form-check-label text-justify" for="tas_hydro">تسمه هیدرولیک تعویض شده</label>
                    </div>
                    <div class="form-check mb-3">
                        <input class="form-check-input form-check-success" name="tas_dinam" id="tas_dinam" type="checkbox"
                               value="on">
                        <label class="form-check-label text-justify" for="tas_dinam">تسمه دینام تعویض شده</label>
                    </div>
                    <div class="form-check mb-3">
                        <input class="form-check-input form-check-success" name="tas_ac" id="tas_ac" type="checkbox"
                               value="on">
                        <label class="form-check-label text-justify" for="tas_ac">تسمه کولر تعویض شده</label>
                    </div>
