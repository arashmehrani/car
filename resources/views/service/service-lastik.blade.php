...
@section('content')
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{route('service.lastik.post')}}">
                    @csrf
                    <input type="hidden" name="plate_id" value="{{$id}}">
                    <div class="form-group">
                        <label class="form-label" for="title">برند محصول</label>
                        <input class="form-control" id="title" name="title" type="text" placeholder="مثال: لاستیک بارز"
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input form-check-success" name="lastik_front" id="lastik_front" type="checkbox"
                               value="on" checked>
                        <label class="form-check-label text-justify" for="lastik_front">لاستیک های جلو تعویض شده</label>
                    </div>
                    <div class="form-check mb-3">
                        <input class="form-check-input form-check-success" name="lastik_back" id="lastik_back" type="checkbox"
                               value="on">
                        <label class="form-check-label text-justify" for="lastik_back">لاستیک های عقب تعویض شده</label>
                    </div>
