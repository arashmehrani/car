...
@section('content')
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{route('service.sham.post')}}">
                    @csrf
                    <input type="hidden" name="plate_id" value="{{$id}}">
                    <div class="form-group">
                        <label class="form-label" for="title">برند محصول</label>
                        <input class="form-control" id="title" name="title" type="text" placeholder="مثال: زیمنس"
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input form-check-success" name="sham" id="sham" type="checkbox"
                               value="on" checked>
                        <label class="form-check-label text-justify" for="sham">شمع ها تعویض شده</label>
                    </div>
                    <div class="form-check mb-3">
                        <input class="form-check-input form-check-success" name="wire" id="wire" type="checkbox"
                               value="on">
                        <label class="form-check-label text-justify" for="wire">وایر ها تعویض شده</label>
                    </div>
